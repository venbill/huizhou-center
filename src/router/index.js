...
export const constantRouterMap = [
    ...
    //         name: 'dashboard',
    //         meta: { title: '系统概况', icon: 'component', roles: ['admin'], noCache: true }
    //     }]
    // }
    // {
    //   path: '/businessWork',
...
export const asyncRouterMap = [{
        ...
        children: [{
            path: '/banner',
            component: () =>
                import ('@/views/admin/banner/index'),
            name: 'banner',
            meta: {
                title: '轮播图',
                icon: 'component',
...

    {
        ...
        children: [{
            path: '/leaveMessage',
            component: () =>
                import ('@/views/admin/leaveMessage/index'),
            name: 'leaveMessage',
            meta: {
                title: '客户留言',
                icon: 'component',
    ...
    },
    {
        ...
        children: [{
            path: '/order',
            component: () =>
                import ('@/views/admin/order/index'),
            name: 'order',
            meta: {
                title: '订单管理',
                icon: 'component',
    ...
    // 店铺管理
    {
        ...
        children: [{
            path: '/shopInfo',
            component: () =>
                import ('@/views/shopkeeper/shopInfo/index'),
            name: 'shopInfo',
            meta: {
                title: '店铺信息',
                icon: 'component',
                roles: ['shopkeeper'] // or you can only set roles in sub nav
            }
        }]
    },
    {
        ...
        children: [{
            path: '/shopType',
            component: () =>
                import ('@/views/shopkeeper/shopType/index'),
            name: 'shopType',
            meta: {
                title: '商品分类',
                icon: 'component',
    ...
    },
    {
        ...
        children: [{
            path: '/goodsManage',
            component: () =>
                import ('@/views/shopkeeper/goodsManage/index'),
            name: 'goodsManage',
            meta: {
                title: '商品管理',
                icon: 'component',
    ...
    },
    {
        ...
        children: [{
            path: '/homestay',
            component: () =>
                import ('@/views/shopkeeper/homestay/index'),
            name: 'homestay',
            meta: {
                title: '民宿管理',
                icon: 'component',
    ...
    },
    {
        ...
        children: [{
            path: '/buyOrder',
            component: () =>
                import ('@/views/shopkeeper/buyOrder/index'),
            name: 'buyOrder',
            meta: {
                title: '电商订单',
                icon: 'component',
    ...
    },
    {
        ...
        children: [{
            path: '/homestayOrder',
            component: () =>
                import ('@/views/shopkeeper/homestayOrder/index'),
            name: 'homestayOrder',
            meta: {
                title: '民宿订单',
                icon: 'component',
